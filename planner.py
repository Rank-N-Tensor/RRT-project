...
path.append(i)
j=None
while j is not start:# this loop searches for the parent  of the node and adds it to the path list
    j=parent_dict[i]
    i=j
    path.append(j)
path.reverse()
path_file=open("RRT_Path_project.csv","w") # the following code generates the csv file
